 ...
 */
public class SoFDRandomizer extends JFrame {
    ...
    private Preferences prefs = Preferences.userNodeForPackage(SoFDRandomizer.class);
    ...
    public static void main(String[] args){
        ...
        SwingUtilities.invokeLater(()->new SoFDRandomizer().setVisible(true));
    }
}
